...
class CreateInvoiceTypePage extends React.Component {

    render() {
        return (
            <React.Fragment>
                <Breadcrumbs
                    breadCrumbTitle="Create new Invoice Type"
                    breadCrumbParent="System Setup"
                    breadCrumbActive="Create new Invoice Type"
                />
                <Row className='mb-2'>
...
export default CreateInvoiceTypePage
