...
class EditPropertyTypePage extends React.Component {

    render() {
        return (
            <React.Fragment>
                <Breadcrumbs
                    breadCrumbTitle="Edit existing Property Type"
                    breadCrumbParent="System Setup"
                    breadCrumbActive="Edit existing Property Type"
                />
                <Row className='mb-2'>
                                        ...
                                        <Col md="6" sm="12">
                                            <FormGroup>
                                                ...
                                                <Input
                                                    ...
                                                    id="propertyTypeName"
                                                    placeholder="Please property type name"
                                                />
                                            </FormGroup>
                                        </Col>
                                        <Col sm="12">
